# Script Name: Percent_Of_Professors_Not_Recommended.py
# Description: This script finds the average percentage that professors are not recommended across the 
#              CSE, ECE, MAE, and Bioengineering departments. This is achieved by getting the average of
#              instructor recommendations for each department and subtracting from 100.
